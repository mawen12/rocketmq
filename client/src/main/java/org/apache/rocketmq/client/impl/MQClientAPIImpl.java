...
public class MQClientAPIImpl implements NameServerUpdateCallback, StartAndShutdown {
    ...
    /**
     * 是否使用{@link SendMessageRequestHeaderV2}，否则使用{@link SendMessageRequestHeader}
     * 从 PROPERTIES(org.apache.rocketmq.client.sendSmartMsg) -> DEFAULT(true)
     */
    ...
    public MQClientAPIImpl(final NettyClientConfig nettyClientConfig, final ClientRemotingProcessor clientRemotingProcessor, RPCHook rpcHook, final ClientConfig clientConfig, final ChannelEventListener channelEventListener) {
        ...
        /**
         * 默认注册RPCHook，用于向请求头添加__ZONE_NAME和__ZONE_MODE
         */
    ...
    public SendResult sendMessage(final String addr, final String brokerName, final Message msg, final SendMessageRequestHeader requestHeader, final long timeoutMillis, final CommunicationMode communicationMode, final SendCallback sendCallback, final TopicPublishInfo topicPublishInfo, final MQClientInstance instance, final int retryTimesWhenSendFailed, final SendMessageContext context, final DefaultMQProducerImpl producer)
        ...
        if (isReply) {
            if (sendSmartMsg) {
                /**
                 * 是回复消息，并且设置了发送智能消息，即以{@link RequestCode#SEND_REPLY_MESSAGE_V2}来构造请求
                 */
                SendMessageRequestHeaderV2 requestHeaderV2 = SendMessageRequestHeaderV2.createSendMessageRequestHeaderV2(requestHeader);
                request = RemotingCommand.createRequestCommand(RequestCode.SEND_REPLY_MESSAGE_V2, requestHeaderV2);
            } else {
                /**
                 * 是回复消息，但并未设置发送智能消息，即以{@link RequestCode#SEND_REPLY_MESSAGE}来构造请求
                 */
            ...
            if (sendSmartMsg || msg instanceof MessageBatch) {
                /**
                 * 非回复消息，但设置了发送智能消息，并且是批次消息，即以{@link RequestCode#SEND_BATCH_MESSAGE}来构造请求；如果不是批次消息，则以{@link RequestCode#SEND_MESSAGE_V2}来构造请求
                 */
                SendMessageRequestHeaderV2 requestHeaderV2 = SendMessageRequestHeaderV2.createSendMessageRequestHeaderV2(requestHeader);
                request = RemotingCommand.createRequestCommand(msg instanceof MessageBatch ? RequestCode.SEND_BATCH_MESSAGE : RequestCode.SEND_MESSAGE_V2, requestHeaderV2);
            } else {
                /**
                 * 非回复消息，并未设置发送智能消息，非批次消息，即以{@link RequestCode#SEND_MESSAGE}来构造请求
                 */
    ...
    private void sendMessageAsync(final String addr, final String brokerName, final Message msg, final long timeoutMillis, final RemotingCommand request, final SendCallback sendCallback, final TopicPublishInfo topicPublishInfo,
                                  final MQClientInstance instance, final int retryTimesWhenSendFailed, final AtomicInteger times, final SendMessageContext context, final DefaultMQProducerImpl producer) {
            ...
            this.remotingClient.invokeAsync(addr, request, timeoutMillis, new InvokeCallback() {
                ...
                public void operationFail(Throwable throwable) {
                    ...
                    if (throwable instanceof RemotingSendRequestException) {
                        ...
                        onExceptionImpl(brokerName, msg, timeoutMillis - cost, request, sendCallback, topicPublishInfo, instance, retryTimesWhenSendFailed, times, ex, context, needRetry, producer);
                    }
                }
            });
        } catch (Exception ex) {
    ...
    private void onExceptionImpl(final String brokerName, final Message msg, final long timeoutMillis, final RemotingCommand request, final SendCallback sendCallback, final TopicPublishInfo topicPublishInfo, final MQClientInstance instance,
                                 final int timesTotal, final AtomicInteger curTimes, final Exception e, final SendMessageContext context, final boolean needRetry, final DefaultMQProducerImpl producer) {
     ...
     * @throws InterruptedException
     */
    public void consumerSendMessageBack(final String addr, final String brokerName, final MessageExt msg, final String consumerGroup, final int delayLevel, final long timeoutMillis, final int maxConsumeRetryTimes) throws RemotingException, MQBrokerException, InterruptedException {
        // 构造消费者发回消息的请求
